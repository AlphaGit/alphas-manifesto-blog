...
This will be later followed by a set of notes on [_how to perform a good code review_]({% post_url 2016/2016-11-17-how-to-perform-a-good-code-review %}).
...
I covered a little bit of this idea in my previous post, [Taming your tools]({% post_url 2016/2016-02-28-taming-your-tools %}). Every content of the pull request that is not helping to achieve the goal is helping to hide it. This usually goes against the tendency of opportunistic refactoring and adjusting styles.
