...
Un tiempo atrás tuvimos una lectura que trataba de <a href="https://blog.alphasmanifesto.com.ar/2008/04/17/link-del-dia-como-explicarle-rest-a-la-mujer-de-uno/">una visión simple de la arquitectura REST</a>. Sin embargo, hay mucho más por comprender en esta arquitectura.

En este caso me dediqué a leer el artículo de <a href="http://izuzak.wordpress.com/">Ivan Zuzak</a>, llamado <a href="http://izuzak.wordpress.com/2010/04/03/why-understanding-rest-is-hard-and-what-we-should-do-about-it-systematization-models-and-terminology-for-rest/">Why understanding REST is hard and what we should do about it</a> (_Por qué comprender REST es difícil y qué deberíamos hacer sobre eso_). El artículo es extenso en demasía, pero quisiera dejar alguna suerte de resumen para que no tengan que lidiar completamente con él sin conocimientos previos:
