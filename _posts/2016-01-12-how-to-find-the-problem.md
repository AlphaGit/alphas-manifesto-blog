...
<p style="text-align: justify;">Since we reviewed the code and found nothing wrong, but yet there <em>is</em> something wrong, let's then review what we know about the code and our failing scenario:</p>
