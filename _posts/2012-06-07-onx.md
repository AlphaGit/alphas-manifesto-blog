...
De parte de [MicroSiervos](http://www.microsiervos.com/archivo/gadgets/onx-microsoft-automatiza-acciones-telefonos-android.html) me entero que Microsoft está desarrollando un sistema de macros basadas en eventos para teléfonos móbiles. El proyecto se llama [on{X}](https://www.onx.ms/) y aquellos que conozcan [IfTTT](https://blog.alphasmanifesto.com/2011/09/26/link-del-dia-if-this-then-that/) verán una gran similaridad.
