...
- id: 9081
  ...
  content: Amigo te felicito por el código, una pregunta,  ¿cómo
...
- id: 9082
  ...
  content: |-
    Muchas gracias! Todavía no he cubierto esa parte pero la velocidad aumenta automáticamente cada vez que la pelota rebota 10 veces sin hacer perder al jugador.

    Estas son las líneas responsables, en la versión actual del código:

    <a href="https://github.com/AlphaGit/random-javascript/blob/master/arkanoid-canvas/arkanoid.js#L44" rel="nofollow">Línea 44</a>: identifica los frames por segundo (FPS) a los que el juego corre. Ese "200" son los FPS del juego. Poner un número más alto acelerará todo el juego proporcionalmente.

    <a href="https://github.com/AlphaGit/random-javascript/blob/master/arkanoid-canvas/arkanoid.js#L271" rel="nofollow">Línea 271</a>: es la velocidad siendo aumentada cada 10 golpes. Multiplicar ese número por un valor mayor a 1 hará que la velocidad aumente más, cambiar 10 por un número más pequeño hará que ocurra más seguido.

    <a href="https://github.com/AlphaGit/random-javascript/blob/master/arkanoid-canvas/arkanoid.js#L256" rel="nofollow">Línea 256</a>: es el movimiento inicial, actualmente de 1 píxel vertical y 1 píxel horizontal. Poner valores más grandes hará que la pelota comience con una velocidad mayor.
