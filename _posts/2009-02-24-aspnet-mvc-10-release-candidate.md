...
Hoy anduve probando esta publicación de Microsoft que pueden descargarse gratuitamente desde <a href="http://go.microsoft.com/fwlink/?LinkID=141184&amp;clcid=0x409">aquí</a>, disponible para VS 2008. Estaba siguiendo las indicaciones que mostraban más que nada las nuevas features, que leí en <a href="http://weblogs.asp.net/scottgu/archive/2009/01/27/asp-net-mvc-1-0-release-candidate-now-available.aspx">Scott's Blog</a>, pero imagino de todos modos que el <a href="http://www.asp.net/mvc/">sitio oficial de ASP.NET MVC</a> estará lleno de tutoriales y explicaciones al respecto.
