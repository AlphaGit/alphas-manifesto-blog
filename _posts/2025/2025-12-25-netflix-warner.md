---
title: Netflix acquires Warner Bros
...
tags:
  ...
  - entertainment
header:
  image: assets/alpha/LotsOfMovies.png
  image_description: Lots of Movies
description: A new era of multimedia might be around the corner, and we're watching it happen
...
Netflix has, for a long while, been at the forefront of technology, even from the standpoint of processes and quality, and they have been pushing the boundaries of what we expect services to be. (Netflix: this is not a bootlick post to you, if you keep degrading your service or increasing prices, I might as well become a sea-dweller.) So much that they created the [Netflix Open Source Software Center](https://netflix.github.io/), giving us jewels like [Nebula](https://nebula-plugins.github.io/) (Gradle plugins), [Dynomite](https://github.com/Netflix/dynomite) (Redis/Memcache server), [Chaos Monkey](https://github.com/Netflix/chaosmonkey) (reliability tester)... and these are just the ones I heard about making the rounds in technical social media. There are many other things they did to give back to the community.
...
a. A change in architecture that improves the capabilities of a network to learn better, or
b. More data
