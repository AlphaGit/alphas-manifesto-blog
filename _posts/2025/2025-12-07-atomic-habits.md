...
header:
  image: assets/alpha/resting.webp
  image_description: Alpha resting
description: A review on Jaems Clear book on habits and ways to change them.
...
If you're interested in the subject but don't want to read a whole book, you can read from [James Clear's blog](https://jamesclear.com/three-steps-habit-change) which talks about the same matter in smaller bite-size pieces.